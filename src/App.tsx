...
{isPlaying ? (
  <VideoPlayer url={movie.watch_link} title={movie.title} autoLandscape={true} />
      ...
      <div className="px-6 mt-8 relative z-10 space-y-6">
        ...
        {!isPlaying && (
          <div className="relative">
            <div className="absolute -top-12 left-1/2 -translate-x-1/2 bg-gradient-to-r from-yellow-400 to-orange-500 text-black text-xs font-black px-4 py-1 rounded-full shadow-2xl ring-2 ring-yellow-400/50 z-20">
              PREMIUM STREAM
            </div>
            <button 
              onClick={() => setIsPlaying(true)}
              className="w-full bg-gradient-to-r from-yellow-400 via-orange-400 to-yellow-500 text-black font-black py-6 rounded-3xl flex items-center justify-center gap-3 shadow-2xl shadow-yellow-500/50 ring-4 ring-yellow-400/30 active:scale-95 transition-all hover:shadow-yellow-500/70 border border-yellow-400/50 backdrop-blur-sm"
            >
